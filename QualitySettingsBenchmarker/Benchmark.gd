...
func benchmark() -> void:
	...
	RenderingServer.viewport_set_measure_render_time(benchmark_viewport_rid, true)
...
#	printt(device_timestamp_diff,
#	RenderingServer.viewport_get_measured_render_time_cpu(viewport.get_viewport_rid())/1000.0)
